...
public class AddRecipesActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText0 = findViewById(R.id.addCategories);
        spinner1 = findViewById(R.id.addSampleType);
        editText2 = findViewById(R.id.addTitle);
        editText3 = findViewById(R.id.addShortStory);
        editText4 = findViewById(R.id.addTime);
        spinner2 = findViewById(R.id.addTimeType);
        spinner3 = findViewById(R.id.addDifficulty);
        editText7 = findViewById(R.id.addIngredients);
        editText8 = findViewById(R.id.addInstructions);
